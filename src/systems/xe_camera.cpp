...
namespace xe {
    ...
    void XECamera::setOrthographicProjection(float left, float right, float top, float bottom, float near, float far) {
    ...
    void XECamera::setCameraParams(float fovy, float aspect, float near, float far) {
        fov_y = fovy;
        cam_aspect = aspect;
        z_near = near;
        z_far = far;
